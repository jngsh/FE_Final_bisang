...
// 방법 2 - discountRate 이용. 밝은 배경일 경우 글자가 안 보임
// const generateBackgroundColor = (rate) => {
//   const normalizedRate = Math.min(Math.max(rate, 0), 1);
//   const hue = 200 + normalizedRate * 60; 
//   const lightness = 100 - normalizedRate * 50; 
//   return `hsl(${hue}, 70%, ${lightness}%)`;
// };

// 방법 3- fixed color and id. discountId가 늘어날 경우 제한적
// const colorMap = {
//   1: "#1f78b4",
//   2: "#33a02c",
//   3: "#e31a1c",
// };
// const generateBackgroundColor = (discountId) => {
//   return colorMap[discountId-1] || '#333';
// };
