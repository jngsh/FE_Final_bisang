        ...
        >
          {products.map((elm, i) => (
            ...
            >
              <div className="position-relative pb-3">
                <div className="pc__img-wrapper pc__img-wrapper_wide3">
                  <Link to={`/product1_simple/${elm.productId}`}>
                    <img
                      loading="lazy"
                      src={elm.productImage || "No Image"} // 기본 이미지
                      width="253"
                      height="198"
                      alt={elm.productName || "No Name"}
                      className="pc__img"
                    />
                  </Link>
                </div>
              ...
              <div className="pc__info position-relative">
                <p className="pc__category">{elm.category || ""}</p>
                <h6 className="pc__title">
                  <Link to={`/product1_simple/${elm.productId}`}>{elm.productName || "No Name"}</Link>
                </h6>
                <div className="product-card__review d-sm-flex align-items-center">
                  <div className="reviews-group d-flex">
                    <Star stars={elm.stars} />
                ...
                <div className="product-card__price d-flex">
                  <span className="money price fs-5">{elm.productPrice || "0"}원</span>
                </div>
              </div>
            </SwiperSlide>
          ))}
